/*
  ...
  - You are about to drop the `item_quantity` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropForeignKey
ALTER TABLE "item_quantity" DROP CONSTRAINT "item_quantity_item_id_fkey";
